...
print("encrypted model execution time for single data sample --- %s seconds ---" % (time.time() - start_time+time1))
Y = np.zeros(Y1.shape)
...
print("decryption time for single data sample--- %s seconds ---" % (time.time() - start_time))
